...
def generate_valentine_card(name, message, design="solid_heart"):
    if design == "solid_heart":
        # ASCII art of a solid heart
        art = '''
        *****     *****
      ********* *********
    ***********************
...
print(generate_valentine_card(name, message, design="solid_heart"))
