...
def draw_square(color, size, x_position, y_position):
    turtle.penup()
...
def draw_triangle(color, size, x_position, y_position):
    turtle.penup()
    turtle.goto(x_position, y_position)
    turtle.pendown()
    turtle.begin_fill()
...
draw_square("green", 100, -50, -300)
draw_text("SQUARE", -270, "yellow")

draw_triangle("orange", 100, 150, -300)
draw_text("TRIANGLE", -270, "green")
